...
const TemplateSelection: React.FC<TemplateSelectionProps> = ({
      ...
      <div className="space-y-6">
        <div className="text-center py-8">
          <h5 className="text-lg font-medium mb-2 text-gray-700">
            {t('outline.noTemplatesAvailable')}
          </h5>
          <p className="text-gray-600 text-sm">
            {t('outline.noTemplatesAvailableDesc')}
          </p>
        </div>
      </div>
    );
  ...
  return (
    <div className="space-y-8 mb-4">
      {/* In Built Templates */}
      <div>
        <h3 className="text-lg font-semibold text-gray-900 mb-3">{t('outline.inBuiltTemplates')}</h3>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
      ...
      <div>
        <div className="flex items-center justify-between mb-3">
          <h3 className="text-lg font-semibold text-gray-900">{t('outline.customAITemplates')}</h3>
        </div>
        {customTemplates.length === 0 ? (
          <div className="text-sm text-gray-600 py-2">
            {t('outline.noCustomTemplates')}
          </div>
        ) : (
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
