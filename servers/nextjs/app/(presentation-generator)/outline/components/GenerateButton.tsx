...
const GenerateButton: React.FC<GenerateButtonProps> = ({
    ...
    const getButtonText = () => {
        ...
        if (streamState.isLoading || streamState.isStreaming) return t('common.loading');
        if (!selectedTemplate) return t('outline.selectTemplate');
        return `${t('outline.generatePresentation')} (${outlineCount * 1} credits)`;
    };
