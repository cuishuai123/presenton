    ...
    <Card className="w-full">
      <CardHeader>
        ...
        {slides.length > 0 && (
          <div className="flex items-center justify-end gap-2">
            ...
            {completedSlides}/{slides.length} {t('customTemplate.slidesCompleted')}
          </div>
        )}
      </CardHeader>
      <CardContent className="space-y-4">
          ...
          <div className="border-2 relative border-dashed border-gray-300 rounded-lg p-8 text-center hover:border-gray-400 transition-colors">
            ...
            <Label htmlFor="file-upload" className="cursor-pointer">
              <span className="text-lg font-medium text-gray-700">
                {t('customTemplate.clickToUpload')}
              </span>
              <input
                id="file-upload"
                type="file"
        ...
        <div className="flex flex-col gap-1 ">
          ...
          >
            {isProcessingPptx
              ? t('customTemplate.extractingSlides')
              : !selectedFile
              ? t('customTemplate.selectFile')
              : t('customTemplate.processFile')}
          </Button>
