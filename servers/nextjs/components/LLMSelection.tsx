...
export default function LLMProviderSelection({
  ...
  useEffect(() => {
    ...
    setButtonState({
      ...
      text: needsModelSelection ? t('settings.pleaseSelectModel') : needsApiKey ? t('settings.pleaseEnterApiKey') : needsOllamaUrl ? t('settings.pleaseEnterOllamaUrl') : t('settings.saveConfiguration'),
      showProgress: false
    });
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              <h3 className="text-sm font-medium text-blue-900 mb-1">
                {t('settings.selectedModels')}
              </h3>
              <p className="text-sm text-blue-700">
                {t('settings.usingForTextGeneration')}{" "}
